<template>
  <div class="flex flex-col gap-6">
    <div class="rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
      <h1 class="text-2xl font-semibold text-gray-900">Area paziente</h1>
    ...
    <div class="grid gap-4 sm:grid-cols-2">
      ...
      >
        ...
        <span class="mt-4 block font-medium text-gray-900 group-hover:text-primary-700">Prenota una visita</span>
        <span class="mt-1 block text-sm text-gray-500">Scegli specialità, prestazione, sede e orario</span>
      </router-link>
